...
% End TeX comment
% orig
% 1/2 t^{A B C} \eta_{K N} E_{C}^{K} E_{A}^{M} \partial_{M}{E_{B}^{N}} + 1/2 t^{A B C} \eta_{K N} E_{A}^{K} E_{B}^{M} \partial_{M}{E_{C}^{N}} + 1/2 t^{A B C} \eta_{K N} E_{B}^{K} E_{C}^{M} \partial_{M}{E_{A}^{N}} - 1/2 t^{A B C} \eta_{K N} E_{B}^{K} E_{A}^{M} \partial_{M}{E_{C}^{N}} - 1/2 t^{A B C} \eta_{K N} E_{C}^{K} E_{B}^{M} \partial_{M}{E_{A}^{N}} - 1/2 t^{A B C} \eta_{K N} E_{A}^{K} E_{C}^{M} \partial_{M}{E_{B}^{N}}
% end_orig
\begin{dmath*}[compact, spread=2pt]
...
% End TeX comment
% orig
% 3 \eta_{M N} E_{A}^{M} E_{B}^{K} \partial_{K}{E_{C}^{N}} t^{A B C}
% end_orig
\begin{dmath*}[compact, spread=2pt]
...
% End TeX comment
% orig
%  - 3 \partial_{m}{b_{n k}} e_{a}^{m} e_{b}^{n} e_{c}^{k} t^{a b c} + 3 f_{a b}^{c} g_{c ea} t^{a b ea}
% end_orig
\begin{dmath*}[compact, spread=2pt]
